...
class Puzzle extends AbstractPuzzle {
  ...
  setAnswers(): void {
    super.setAnswers(102, 1023, 94, 1165);
  }
...
// I think initializing a NodeMap with a vertical / horizontal option for each cell,
// then adding paths between each node with a weight of their value,
// then running a dijkstra algorithm to find the best path will be much faster
export const puzzle = new Puzzle('2023', '17', PuzzleStatus.INEFFICIENT);
